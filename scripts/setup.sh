...
echo "=========================================="
echo ""
echo "1. Install Node.js dependencies (if not already done):"
echo "   npm install mongodb dotenv"
echo ""
echo "2. Provision test subscriber to MongoDB:"
echo "   node scripts/provision-subscriber.js"
echo ""
echo "3. Start the 5G Core network:"
echo "   docker compose up -d"
echo "   OR use: ./scripts/start-core.sh"
echo ""
echo "4. Start UERANSIM test:"
